...
export function middleware(request: NextRequest) {
  ...
  const publicAdminRoutes = ['/dashboard', '/actividades', '/horarios', '/espacios', '/reservas', '/socios', '/familias', '/noticias', '/torneos', '/eventos', '/cobros', '/usuarios', '/liquidaciones', '/config'];
