...
import { MapSection } from "@/app/landing/components/MapSection";
import { ContactSection } from "@/app/landing/components/ContactForm";
      ...
      <header className="fixed top-0 left-0 right-0 bg-white border-b border-slate-200 z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <LanguageSwitcher />
            <Link
              href="/supercalifragilisticoespiralidoso/acceso"
